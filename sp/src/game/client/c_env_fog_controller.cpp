...
BEGIN_NETWORK_TABLE_NOBASE( CFogController, DT_FogController )
	...
	RecvPropInt( RECVINFO( m_fog.colorPrimary ), 0, RecvProxy_IntToColor32 ),
	RecvPropInt( RECVINFO( m_fog.colorSecondary ), 0, RecvProxy_IntToColor32 ),
	...
	RecvPropInt( RECVINFO( m_fog.colorPrimaryLerpTo ), 0, RecvProxy_IntToColor32 ),
	RecvPropInt( RECVINFO( m_fog.colorSecondaryLerpTo ), 0, RecvProxy_IntToColor32 ),
